...
export default class Experience extends Component {
    ...
    selectType(typeId) {
        ...
        if (document.getElementsByClassName("experience-type") && document.getElementsByClassName("experience-type").length > 0) {
    ...
    experienceTypeContainer(experience) {
        return (
            <div onClick={() => { this.selectType(experience.description) }} key={experience.description} id={experience.description} className="experience-type">
                <div className="experience-type-image">
                    <img width='150px' height='150px' src={experience.image} alt={experience.altText} />
                </div>
