...
export default class Contact extends Component {
  ...
  runFormValidation() {
    ...
    if (!this.state.subjectLine.trim()) isValid = false;
    return isValid;
  }
      ...
      <div className="top-container">
        <div className="content">
          ...
          <p>
            ...
            <a
              href="https://www.linkedin.com/in/sairaj-udayshankar"
              target="blank"
            >
              LinkedIn
            </a>
          ...
          <p>Or, use the below form to get in touch.</p>
          <p>
            <label>
              Your Email Address <span className="required-indicator">*</span> :
            </label>
          </p>
          <input
          ...
          <input
            ...
            onChange={this.subjectLineChange}
          ></input>
          <p>Message :</p>
          <textarea
            className="input-dimensions"
          ...
          {!this.state.isFormValid && (
            <p className="error-message">
              Please enter a valid email ID and a subject line
            </p>
          )}
        </div>
      </div>
